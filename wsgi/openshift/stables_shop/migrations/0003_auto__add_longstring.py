...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LongString'
        db.create_table(u'django_settings_longstring', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'stables_shop', ['LongString'])


    def backwards(self, orm):
        # Deleting model 'LongString'
        db.delete_table(u'stables_shop_longstring')
    ...
    models = {
        ...
        u'stables_shop.longstring': {
            'Meta': {'object_name': 'LongString'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
