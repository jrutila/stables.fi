...
setup(
    ...
    url='',
    install_requires=[ 'Django==1.5', 'django-tenant-schemas', 'filterspecs', 'django-reusableapps==0.1.1', 'djangorestframework', 'django-grappelli', 'django-stables==dev', 'django-compressor' ],
    zip_ok=False,
    zip_safe=False,
    dependency_links = [
